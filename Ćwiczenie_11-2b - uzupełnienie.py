...
def szukanie_przybliżonej_wartości (value, procenty):
    najmniejsza_wartość = value - (procenty / 100) * value
    najwyższa_wartość = value + (procenty / 100) * value
    return random.randint (najmniejsza_wartość, najwyższa_wartość)
